...
return ( 
	...
	<div className="w-full max-w-4xl p-4"> 
		<h1 className="text-sky-600 text-3xl font-semibold text-center mb-4"> 
		Calorie Meter 
		</h1> 
		{showWarning && ( 
		...
		<div className="mt-3 flex justify-between"> 
			...
			{editItem ? ( 
				<button 
				className="bg-sky-500 text-white p-3 rounded-md hover:bg-blue-600 mb-4 
				...
				<button 
				className="bg-sky-500 text-white p-3 rounded-md hover:bg-green-700 mb-4 
				font-semibold focus:outline-none text-xs"
			...
			<button 
				className="bg-sky-500 text-white p-3 rounded-md font-semibold mb-4 hover:bg-red-700 
		...
		{nutritionItems.map((item) => ( 
			...
			<ul className="mt-3"> 
				...
				<button 
					className="bg-sky-500 text-white hover:bg-red-600 p-2 rounded-md font-semibol"
					onClick={() => updateItemQuantity(item.id, -1)} 
				> 
			...
			<div className="mt-3 flex justify-between"> 
				<button 
				className="bg-sky-500 text-white pd-2 rounded-md hover:bg-blue-600 
				font-semibold focus:outline-none text-xs"
				...
				<button 
				className="bg-sky-500 text-white pd-2 rounded-md hover:bg-red-600 
				font-semibold focus:outline-none text-xs"
